...
export default function BThere() {
  ...
  return (
    <ProjectExpanded
      ...
      description="Helps users be a better friend to their friends by analyzing video conversations and providing suggestions for users to connect with their friends on a deeper level."
      implementation={[
        "Mood analysis using Google Cloud facial recognition and speech-to-text",
        "Personalized suggestions via OpenAI API",
        "Speaker face recognition using Amazon Facial Rekognition",
        "Data storage and authentication managed with Flask and Firebase",
        "Website built with React and shadcn-ui",
        "Real-time video chat streaming enabled by WebRTC and Socket.io",
